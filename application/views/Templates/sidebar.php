<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?=base_url()?>beranda">Forecasting Covid 19</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">FC19</a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?=base_url()?>hasilperhitungan"><i class="fas fa-calculator"></i> <span>Hasil Perhitungan</span></a></li>
            
            <li class="menu-header">GIS</li>
            <li><a class="nav-link" href="<?=base_url()?>gis"><i class="fas fa-map-marked-alt"></i> <span>Geographic Information System</span></a></li>
