                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="<?= base_url() ?>assets/img/z.png" alt="logo" width="100">
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="flash-data-news1" data-flashdata="<?= $this->session->flashdata('flash1') ?>">

                            </div>
                            <div class="flash-data-data1" data-flashdata="<?= $this->session->flashdata('data1') ?>">
                            </div>
